              ...
              children: [
                ...
                ListTile(
                  ...
                  title: Text(
                    'Logout',
                    style: TextStyle(
                        fontSize: _drawerFontSize, color: Colors.black),
                  ),
                  onTap: () {
                    SystemNavigator.pop();
                  },
  ...
  Widget build(BuildContext context) {
    ...
    return CupertinoTabBar(
      items: [
        ...
        _buildTabBarItem('Resources', CupertinoIcons.doc_checkmark,
            CupertinoIcons.doc_checkmark_fill),
        _buildTabBarItem(
            'Doctors', CupertinoIcons.person, CupertinoIcons.person_solid),
      ],
      onTap: onTap,
