  ...
  void getMarker() {
    markerListData.forEach((element) {
      ...
      markerList.add(Marker(
        ...
        position: LatLng(double.parse(element.locationLat.toString()),
            double.parse(element.locationLon.toString())),
                          ...
                          children: <Widget>[
                            ...
                            Row(
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                      "It is unsafe to consume alcohol with Napa 500."),
                                  flex: 4,
                                )
                              ],
                            ),
                            ...
                            Row(
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                      "Napa 500 is safe to use during pregnancy. Most studies have shown low or no risk to the developing baby"),
                                  flex: 4,
                                )
                              ],
                            ),
                            ...
                            Row(
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                      "Napa 500 does not usually affect your ability to drive."),
                                  flex: 4,
                                )
                              ],
                            ),
                            ...
                            Row(
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                      "Napa 500 should be used with caution in patients with kidney disease. Dose adjustment of Napa 500 may be needed. Please consult your doctor."),
                                  flex: 4,
                                )
                              ],
                            )
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Container(
                              child: Text(
                                  "Napa 500 is a medicine used to relieve pain and to "
